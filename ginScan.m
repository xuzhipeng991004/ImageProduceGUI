function [out1,out2,out3] = ginScan(arg1,pointer)
...
if ~matlab.ui.internal.isFigureShowEnabled
    ...
    initialState = setupFcn(fig,pointer);
...
function initialState = setupFcn(fig,pointer)
...
set(fig,'pointer',pointer,'PointerShapeHotSpot',hotspot)
